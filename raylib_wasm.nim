...
proc emscripten_set_main_loop*(f: em_callback_func, fps, simulate_infinite_loop: cint) {.importc, header: "<emscripten.h>".}
...
proc main() = 
  ...
  emscripten_set_main_loop(UpdateGameWindow, 0, 1)
